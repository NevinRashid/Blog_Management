...
use App\Events\PostValidationSuccefly;
...
class UpdatePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules=[
            ...
            'keywords'         => ['nullable','string','regex:/^([A-Za-z0-9_-]+)(,\s*[A-Za-z0-9_-]+)*$/',new ValidKeywords(10),'max:255'],
    ...
    public function messages():array
    {
        return[
            ...
            'keywords.regex'        => 'صيغة الكلمات المفتاحية غير صحيحة يجب أن يفصل بين الكلمات فواصل',
            'keywords.max'          => 'لا يجوز أن يكون طول هذا الحقل أكثر من 255 محرف',
    ...
    */
    ...
    protected function passedValidation(): void{
        event(new PostValidationSuccefly($this->validated()));
    }
